...
CBUFFER_START(DirectLighting)
    ...
    float4 _SunLightShadowFadeParams; // x: 1.0 / max shadow distance, y: 1.0 / distance fade, z: 1.0 / cascade edge fade, w: shadow mask channel
...
TEXTURE2D(_EnvBRDFLut);
SAMPLER(sampler_Point_Clamp_EnvBRDFLut);
