...
namespace YPipeline.Editor
{
    ...
    public class FilmGrainEditor : VolumeComponentEditor
    {
        ...
        private SerializedDataParameter m_Response;
        private SerializedDataParameter m_Texture;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_Type.value.intValue == (int) FilmGrainKinds.Custom)
            {
                using (new IndentLevelScope()) PropertyField(m_Texture);
        ...
        public static void SetTextureImportSettings(TextureImporter importer)
        {
            importer.textureType = TextureImporterType.SingleChannel;
            importer.alphaSource = TextureImporterAlphaSource.FromGrayScale;
