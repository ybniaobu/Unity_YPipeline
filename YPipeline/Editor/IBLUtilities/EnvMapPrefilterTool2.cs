...
public class EnvMapPrefilterTool2 : OdinEditorWindow
{
    ...
    [InfoBox("这个工具预过滤时生成的 Cubemap 在高粗糙度下会有边缘接缝衔接问题，暂未解决")]
    ...
    [Range(0, 360)] public float rotation = 90.0f;
    ...
    [Sirenix.OdinInspector.FilePath] public string csPath = "Assets/YPipeline/Editor/IBLUtilities/EnvMapPrefilter.compute";
