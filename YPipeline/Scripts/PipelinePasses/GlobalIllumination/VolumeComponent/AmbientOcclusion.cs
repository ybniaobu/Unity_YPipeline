...
namespace YPipeline
{
    ...
    public class AmbientOcclusion : VolumeComponent, IPostProcessComponent
    {
        ...
        [Tooltip("过滤核半径 Defines the neighborhood area used for weighted averaging. Larger kernels produce stronger blurring effects.")]
        public ClampedIntParameter kernelRadius = new ClampedIntParameter(2, 1, 4);
        
        [Tooltip("高斯模糊标准差 The standard deviation, also called the Gaussian width, higher value results in blurrier result, lower value keep more details.")]
        public ClampedFloatParameter sigma = new ClampedFloatParameter(2.0f, 0.5f, 5.0f);
