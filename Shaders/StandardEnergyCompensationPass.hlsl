#ifndef YPIPELINE_STANDARD_ENERGY_COMPENSATION_PASS_INCLUDED
#define YPIPELINE_STANDARD_ENERGY_COMPENSATION_PASS_INCLUDED
...
float4 StandardFrag(Varyings IN) : SV_TARGET
{
    ...
    float3 envBRDFDiffuse = standardPBRParams.albedo;
